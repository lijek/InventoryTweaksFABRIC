...
public class InvTweaksConfig {
    ...
    public void resolveConvenientInventoryConflicts() {
        ...
        try {
            ...
            // the specific field provided for net.invtweaks.InvTweaks
            ...
            // Older versions of CI: disable net.invtweaks.InvTweaks middle click
            else {
        ...
        // If CI's middle click is enabled, disable net.invtweaks.InvTweaks shortcut
